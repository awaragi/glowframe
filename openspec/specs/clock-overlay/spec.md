...
Defines the digital clock overlay feature — a fixed-position time display rendered on the light surface, configurable per profile with position, size, and format options.

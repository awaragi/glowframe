...
This capability defines a demonstration mode for Playwright E2E tests. When activated, tests run in a headed browser with slowed-down actions and sequential execution, making test interactions clearly observable for demo purposes.

...
Defines Progressive Web App (PWA) installability requirements — enabling GlowFrame to be installed as a standalone app on any device, with a valid web manifest, registered service worker, and offline capability.
